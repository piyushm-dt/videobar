...
from videox.forms import LoginForm, RegisterForm, NewVideoForm, CommentForm
...
class VideoView(View):
    ...
    def get(self, request, id):
        ...
        video_by_id.path = '/static_cdn/' + video_by_id.path
...
class NewVideo(View):
    ...
    def post(self, request):
        ...
        if form.is_valid():
            ...
            path1 = random_char+file.name
            path2 = random_char+image.name

            path3 = 'media/'+path2
            path4 = 'media/'+path1

            path2 = 'static_cdn/media/' + path2
            path1 = 'static_cdn/media/' + path1
